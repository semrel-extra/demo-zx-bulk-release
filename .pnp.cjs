...
'{\
  ...
  "dependencyTreeRoots": [\
    ...
    {\
      "name": "@semrel-extra/zxbr-test-b",\
      "reference": "workspace:packages/b"\
    },\
    {\
      "name": "@semrel-extra/zxbr-test-c",\
      "reference": "workspace:packages/c"\
    },\
    {\
      "name": "@semrel-extra/zxbr-test-d",\
      "reference": "workspace:packages/d"\
    }\
  ],\
  "enableTopLevelFallback": true,\
  "ignorePatternData": "(^(?:\\\\.yarn\\\\/sdks(?:\\\\/(?!\\\\.{1,2}(?:\\\\/|$))(?:(?:(?!(?:^|\\\\/)\\\\.{1,2}(?:\\\\/|$)).)*?)|$))$)",\
  "fallbackExclusionList": [\
    ["@semrel-extra/zxbr-test-a", ["workspace:packages/a"]],\
    ["@semrel-extra/zxbr-test-b", ["workspace:packages/b"]],\
    ["@semrel-extra/zxbr-test-c", ["workspace:packages/c"]],\
    ["@semrel-extra/zxbr-test-d", ["workspace:packages/d"]],\
    ["demo-zx-bulk-release", ["workspace:."]]\
  ],\
  "fallbackPool": [\
  ],\
  "packageRegistryData": [\
    ...
    ["@semrel-extra/zxbr-test-c", [\
      ["workspace:packages/c", {\
        "packageLocation": "./packages/c/",\
        "packageDependencies": [\
          ["@semrel-extra/zxbr-test-c", "workspace:packages/c"],\
          ["@semrel-extra/zxbr-test-a", "workspace:packages/a"],\
          ["@semrel-extra/zxbr-test-d", "workspace:packages/d"]\
    ...
    ["@semrel-extra/zxbr-test-d", [\
      ["workspace:packages/d", {\
        "packageLocation": "./packages/d/",\
        "packageDependencies": [\
          ["@semrel-extra/zxbr-test-d", "workspace:packages/d"],\
          ["@semrel-extra/zxbr-test-a", "workspace:packages/a"]\
        ],\
